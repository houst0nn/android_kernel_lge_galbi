...
#ifdef CONFIG_MACH_LGE
/* LGE_UPDATE, 20130430, ws.yang@lge.com, Setting to pull up of pin the SD_DETECT */
...
/*
static struct gpiomux_setting vibrator_active_cfg_gpio145 = {
       .func = GPIOMUX_FUNC_GPIO,
       .drv = GPIOMUX_DRV_2MA,
       .pull = GPIOMUX_PULL_NONE,
};
...
static struct msm_gpiomux_config vibrator_configs[] = {
	...
	/*{
		.gpio = 145,
		.settings = {
			[GPIOMUX_ACTIVE]    = &vibrator_active_cfg_gpio145,
			[GPIOMUX_SUSPENDED] = &vibrator_suspend_cfg,
		},
	},*/
};
